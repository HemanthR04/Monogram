    ...
    return ( 
        <>
            <div className="footer-container font-Inter w-full h-productheight bg-navblue text-pink1">
                <div className="footer-links sm:flex items-top justify-center gap-24 py-12 px-2 overflow-clip">
                    ...
                    <p className="sm:w-96">Master productivity with Creative Console and get all the latest Monogram news.</p>
                    <div className="email flex gap-2 sm:gap-4 items-center my-2">
                        <input type="text" className="bg-transparent  border-2 border-pink1 p-2"  placeholder="Email Address"/>
                        <button className="bg-pink1  text-navblue text-xs px-8 h-10 border-2 border-pink1 rounded-3xl font-bold opacity-70 hover:opacity-100">SUBMIT</button>
                    </div>
