function NavBar() {
    return ( 
        <>
            <div className="z-10 navbar-container flex items-center justify-between bg-navblue text-pink1 w-96 sm:w-navwidth h-14 m-auto font-Inter fixed  top-2 left-0 sm:top-4 sm:left-4" >
                ...
                <div className="hidden md:inline">
                    <ul className="flex  mx-4">
                        <li className="px-2 mx-2"><a href="">HOW IT WORKS</a></li>
                        <li className="px-2 mx-2"><a href="">WORKFLOWS</a></li>
                        <li className="px-2 mx-2"><a href="">DOWNLOAD</a></li>
                        <li className="px-2 mx-2"><a href="">BLOG</a></li>
                        <li className="px-2 mx-2"><a href="">SUPPORT</a></li>
                        <li className="px-2 mx-2"><a href="">SHOP</a></li>
                        <li className="px-2 mx-2"><a href="">USD</a></li>
                    </ul>
                </div>
