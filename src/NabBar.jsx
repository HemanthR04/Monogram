function NavBar() {
    return ( 
        <>
            <div className="z-10 rounded-md navbar-container flex items-center justify-between bg-navblue text-pink1 w-full sm:w-navwidth h-14 m-auto font-Inter fixed  top-2 left-0 sm:top-4 sm:left-4" >
                ...
                <div className="hidden md:inline">
                    <ul className="flex  mx-4">
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue"><a href="">HOW IT WORKS</a></li>
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue "><a href="">WORKFLOWS</a></li>
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue "><a href="">DOWNLOAD</a></li>
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue "><a href="">BLOG</a></li>
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue "><a href="">SUPPORT</a></li>
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue "><a href="">SHOP</a></li>
                        <li className="px-4  mx-2 rounded-xl hover:bg-pink1 hover:text-navblue "><a href="">USD</a></li>
                    </ul>
                </div>
